...
// ============ SHEET 2: Keyword Research (UNCHANGED) ============
const keywords = [
...
// ============ SHEET 3: Competitor Comparison (UPDATED — 7 competitors) ============
const competitors = [
  ['COMPETITOR COMPARISON', '', '', '', '', '', '', ''],
  [],
  [
    'Metric',
    'livingparkcityutah.com',
    'Laura Willis',
    'Fisher Group (Christie\'s)',
    'Derrik Carlson (KW)',
    'Magnotta (Christie\'s)',
    'PC Investor (KW)',
    'Inhabit PC (SSIR)',
  ...
  [
    'Total Pages',
    62, 372, 376, '120+', 425, '834+', '170+',
  ],
  [
    'Blog Posts',
    5, 96, 33, '10+', 207, 396, 69,
  ],
  [
    'Community Pages',
    '28 (~200 words)',
  ...
  [
    'Ski Pages',
    1, 20, 3, '5+', 'In blog', 'Various', 'In neighborhoods',
  ],
  [
    'Golf Pages',
    0, 11, 6, '2+', 'In blog', 'Various', 0,
  ],
  [
    'Market Reports',
    'None', 'None', 'None', '1 (continuously updated)', 'None', 'Yes (quarterly)', 'Yes (quarterly)',
  ],
  [
    'Local Resource Pages',
    'None', 'None', '1 (hiking guide)', 'None', '14 ("Best of PC")', 'None', 'TownLift partnership',
  ],
  [
    'Testimonials',
    'No',
  ...
  [
    'Schema Markup',
    'No', 'No', 'YES', 'No', 'YES', 'YES (Yoast)', 'No',
  ],
  [
    'Canonical Tags',
    'Partial', 'Yes', 'Yes', 'Yes', 'Partial', 'Yes', 'Yes',
  ],
  [
    'Single H1/Page',
    'No (3 on HP)',
  ...
  [
    'FAQ Sections',
    'No', 'No', 'Yes (homepage)', 'Yes (community pages)', 'No', 'Yes (homepage schema)', 'Yes (newest blog only)',
  ],
  [
    'Platform',
    'Sierra Interactive',
  ...
  [],
  [
    'KEY TAKEAWAY: parkcityinvestor.com has 834+ pages — 13x more content. 3 competitors are in the same brokerage (Summit Sotheby\'s). Schema markup is a first-mover opportunity.',
    '', '', '', '', '', '', '',
  ],
];

// ============ SHEET 4: Action Plan (45 Items) (UNCHANGED) ============
const actionPlan = [
...
// ============ SHEET 5: Content Calendar (UNCHANGED) ============
...
// ============ SHEET 6: Deliverables Summary (UNCHANGED) ============
const deliverables = [
...
// ============ SHEET 7: New Competitor Deep Dives (NEW) ============
const deepDives = [
  ['NEW COMPETITOR DEEP DIVES', '', '', ''],
  ['Detailed analysis of two newly audited competitors + PCLER About page review', '', '', ''],
  [],

  // ---- Section 1: parkcityinvestor.com ----
  ['SECTION 1: parkcityinvestor.com', '', '', ''],
  [],
  ['Field', 'Detail', '', ''],
  ['Agent(s)', 'Annett Blankenship + Drew Via', '', ''],
  ['Brokerage', 'Keller Williams Park City', '', ''],
  ['Platform', 'WordPress + Elementor + Yoast SEO', '', ''],
  ['Total Content', '834+ URLs (438 pages + 396 blog posts)', '', ''],
  ['Subdivision Pages', '214 subdivision landing pages covering every Park City neighborhood', '', ''],
  ['IDX / MLS', 'Full IDX/MLS integration with property search', '', ''],
  ['Schema Markup', 'Yes — FAQPage, LocalBusiness, Organization, Article, BreadcrumbList', '', ''],
  ['Market Reports', 'Quarterly (Q1–Q4 2025 published)', '', ''],
  ['Blog Cadence', '2–4 posts/month', '', ''],
  ['Key Strength', 'Sheer volume and neighborhood coverage — 13x more content than client', '', ''],
  ['Key Weakness', 'Page speed (45+ seconds), bulk-imported content, Keller Williams brand (not luxury)', '', ''],
  ['Threat Level', 'HIGH — most content-heavy competitor in the Park City market', '', ''],
  [],

  // ---- Section 2: inhabitparkcity.com ----
  ['SECTION 2: inhabitparkcity.com', '', '', ''],
  [],
  ['Field', 'Detail', '', ''],
  ['Agent(s)', 'Julie Snyder + Lindsey Midiri', '', ''],
  ['Brokerage', 'Summit Sotheby\'s International Realty (SAME as client)', '', ''],
  ['Platform', 'Luxury Presence', '', ''],
  ['Total Content', '170+ pages', '', ''],
  ['Neighborhood Coverage', '32 neighborhood guides + 17 development pages', '', ''],
  ['Media Partnership', 'Weekly TownLift partnership (300K+ monthly readers)', '', ''],
  ['Schema Markup', 'No — same weakness as client site', '', ''],
  ['Market Reports', 'Yes (quarterly statistics)', '', ''],
  ['Blog Cadence', 'Monthly newsletters + weekly TownLift articles', '', ''],
  ['Key Strength', 'Media partnership, polished Luxury Presence design, strong lead capture', '', ''],
  ['Key Weakness', 'Thin neighborhood pages (300–400 words), no schema, newsletter stopped Oct 2024', '', ''],
  ['Threat Level', 'HIGH — same brokerage, strong personal brand, active media presence', '', ''],
  [],

  // ---- Section 3: PCLER About Page Analysis ----
  ['SECTION 3: PCLER About Page Analysis (Tisha\'s Specific Request)', '', '', ''],
  [],
  ['Metric', 'PCLER (Competitor)', 'livingparkcityutah.com (Client)', 'Gap / Action'],
  ['About Page Word Count', '1,899 words', '602 words', 'Client is 3x thinner — expand significantly'],
  ['Google Reviews Widget', 'Embedded (47 reviews, 5.0 stars)', 'None', 'Add Google Reviews embed — high trust signal'],
  ['"As Featured In" Logos', 'Vogue, WSJ, Yahoo Finance, Ski Utah', 'None', 'Pursue press coverage + add logos section'],
  ['Notable Achievement Highlighted', '$25M record Deer Valley sale', 'No specific achievements named', 'Name specific sales, records, or milestones'],
  ['Contact Form on About Page', 'Yes', 'No', 'Add contact form or CTA directly on page'],
  ['Schema Markup', 'Product schema with AggregateRating', 'None', 'Add AggregateRating schema once reviews added'],
  ['Meta Title', 'Optimized', 'Generic', 'Rewrite with keywords + value proposition'],
  ['Keyword Stuffing Block', 'N/A', 'Present — penalty risk', 'Remove immediately (Quick Win #7)'],
  [],
  ['TOP ABOUT PAGE RECOMMENDATIONS FOR TISHA', '', '', ''],
  ['Priority', 'Recommendation', 'Effort', 'Impact'],
  [1, 'Fix meta title — include name, location, and specialty (not just "About")', 'Low', 'High'],
  [2, 'Remove keyword-stuffing paragraph — dated tactic, penalty risk', 'Low', 'High'],
  [3, 'Add Google Reviews embed widget (47+ reviews, 5-star rating is achievable)', 'Low-Medium', 'High'],
  [4, 'Name specific credentials and achievements (record sales, years in market, transaction volume)', 'Medium', 'High'],
  [5, 'Add "As Featured In" or media logos section (work toward press placements)', 'Medium', 'Medium'],
  [6, 'Add contact form or consultation CTA directly on the About page', 'Low', 'High'],
  [7, 'Expand page to 1,200+ words with bio, story, philosophy, and team info', 'Medium', 'Medium'],
  [8, 'Add AggregateRating schema once Google Reviews are embedded', 'Low', 'High'],
];
...
addSheet(wb, deepDives, 'New Competitor Deep Dives', [
  { wch: 32 }, { wch: 55 }, { wch: 40 }, { wch: 45 },
]);

const outPath = '/mnt/c/Dev/site audit/deliverables/SEO-Audit-GamePlan-v2.xlsx';
