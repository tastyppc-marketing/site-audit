...
async function checkDirectory(dirName, searchUrl, clientDomain, clientName) {
  ...
  try {
    ...
    // Require either an exact domain hit OR the FULL business name as a substring.
    // The previous heuristic (first-word substring of name) matched any page
    // containing e.g. "Matt" -> "Matt's Deli", inflating the found count.
